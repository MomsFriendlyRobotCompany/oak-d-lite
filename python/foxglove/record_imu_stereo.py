...
from thebrian import write_mcap


vec_t = namedtuple("vec_t","x y z")
imu_t = namedtuple("imu_t","a g timestamp")
    ...
    try:
        while True:
            ...
            for imuPacket in imuPackets:
                ...
                aa = vec_t(a.x,a.y,a.z)
                gg = vec_t(g.x,g.y,g.z)
                data["imu"].append(imu_t(aa,gg,ts))
